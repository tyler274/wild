use super::ElfLayout;
use super::SymbolSection;
use super::SymbolTableWriter;
use super::TableWriter;
use super::apply_debug_relocations;
use super::apply_relocations;
use super::input_section_reloc_scratch;
use super::should_reverse_contents;
use super::write_eh_frame_data;
use super::write_rela_section;
use super::write_rela_sections;
use super::write_section_raw;
