...
use super::symbols::{SymbolTableWriter, VersionWriter, VersionedDynsymWriter};
use crate as elf;
use crate::writable_elf::{WritableRela as _, WritableRelr as _};
use crate::{EhFrameHdr, EhFrameHdrEntry, ElfClass, ElfWord as _, debug_assert_bail, part_id};
