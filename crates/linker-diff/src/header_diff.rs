use crate::{Binary, Config, Diff, DiffValues, Report, Result, slice_from_all_bytes};
use anyhow::{Context as _, anyhow, bail};
use hashbrown::{HashMap, HashSet};
use itertools::Itertools;
#[allow(clippy::wildcard_imports)]
use linker_utils::elf::secnames::*;
use linker_utils::elf::{SectionFlags, shf};
#[allow(clippy::wildcard_imports)]
use object::elf::*;
use object::macho::{LC_CODE_SIGNATURE, LC_DYLD_CHAINED_FIXUPS, SECTION_ATTRIBUTES};
use object::read::elf::Dyn;
use object::read::macho::{LoadCommandVariant, MachHeader};
use object::{Endianness, Object as _, ObjectSection as _, ObjectSymbol as _, Section};
use std::borrow::Cow;
