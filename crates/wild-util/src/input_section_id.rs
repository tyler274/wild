...
pub struct SectionIdRange {
    start_section_id: InputSectionId,
    num_sections: usize,
}

impl InputSectionId {
    pub fn from_usize(value: usize) -> InputSectionId {
    ...
    pub fn add_usize(self, value: usize) -> InputSectionId {
        Self::from_usize(self.as_usize() + value)
    }
}

impl SectionIdRange {
    pub fn input(start_section_id: InputSectionId, num_sections: usize) -> Self {
        Self {
            start_section_id,
            num_sections,
        }
    ...
    pub fn start(&self) -> InputSectionId {
    ...
    pub fn input_to_id(&self, section_index: object::SectionIndex) -> InputSectionId {
        debug_assert!(
