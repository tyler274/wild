...
pub fn update_defsym_symbol_resolution<'data, P: EnginePlatform>(
...
pub fn update_dynamic_symbol_resolutions<'data, P: EnginePlatform>(
...
pub fn finalise_all_sizes<'data, P: EnginePlatform, A: Arch<Platform = P>>(
...
pub fn merge_dynamic_symbol_definitions<'data, P: EnginePlatform>(
...
pub fn create_canonical_plt_entries<'data, P: EnginePlatform>(
    group_states: &[GroupState<'data, P>],
    symbol_db: &SymbolDb<'data, P>,
...
pub fn append_prelude_defsym_dynamic_symbols<'data, P: EnginePlatform>(
    group_states: &[GroupState<'data, P>],
    symbol_db: &SymbolDb<'data, P>,
    dynamic_symbol_definitions: &mut Vec<DynamicSymbolDefinition<'data, P>>,
) -> Result {
...
pub fn compute_total_file_size(section_layouts: &OutputSectionMap<OutputRecordLayout>) -> u64 {
    let mut file_size = 0;
...
pub fn compute_allocations<P: EnginePlatform>(
...
pub fn relocate_gnu_build_id_allocation<P: EnginePlatform>(
    output_sections: &mut OutputSections<P>,
...
pub fn relocate_gnu_build_id_layout_offset<P: EnginePlatform>(
...
pub fn allocate_thunk_block_space<P: EnginePlatform>(
...
pub fn propagate_section_attributes<'data, P: EnginePlatform>(
    group_states: &[GroupState<'data, P>],
    output_sections: &mut OutputSections<P>,
) {
...
pub fn apply_non_addressable_indexes<'data, P: EnginePlatform>(
    group_states: &mut [GroupState<'data, P>],
    symbol_db: &SymbolDb<'data, P>,
...
pub fn starting_memory_offsets(
...
pub fn compute_file_sizes<P: EnginePlatform>(
...
pub fn verify_consistent_allocation_handling<P: EnginePlatform, A: Arch<Platform = P>>(
    flags: ValueFlags,
    output_kind: OutputKind,
    args: &P::Args,
) -> Result {
